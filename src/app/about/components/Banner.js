        ...
        <>
            <div className="relative">
                ...
                <div className="absolute top-[24%] left-[32%]">
                    <div className="flex flex-col justify-center items-center  bg-black bg-opacity-50 backdrop-filter backdrop-blur-2 w-[110px] h-[137px] 375:w-[128px] 375:h-[158px] 425:w-[148px] 425:h-[180px] md:w-[272px] md:h-[328px] 1024:w-[262px] 1024:h-[238px] lg:w-[450px] lg:h-[540px] 2xl:w-[900px] 2xl:h-[1090px]">
                        <p className="text-white text-shadow font-LeagueSpartan text-[15px] font-[700] md:text-[35px] 1024:text-[60px] lg:text-[80px] 2xl:text-[120px]">
                            WHY US?
                        </p>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 39 22" fill="none" className="w-[16px] h-[6px] md:w-[20px] md:h-[10px] 1024:w-[25px] 1024:h-[15px] lg:w-[30px] lg:h-[20px] 2xl:w-[40px] 2xl:h-[30px]">
