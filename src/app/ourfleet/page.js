...
function OurFleet() {
  return (
    ...
    <div class="flex flex-wrap">
      <div class="bg-black w-full sm:w-full md:w-full lg:w-1/2 lg:p-64 md:p-32 sm:p-24">
        <div>
          <h1 className="text-white font-montserrat text-[30px] font-medium tracking-[12px] uppercase text-center mb-24 pt-14">Party Bus</h1>
          <p className="text-[20px] font-archivo text-center text-white font-light">
          ...
          <br />
          <br />
          <p className="text-[20px] font-archivo text-center text-white">
