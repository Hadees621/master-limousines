...
function Contact() {
  return (
    <div className="w-full">
      <section className="mb-32 flex w-full flex-col items-center justify-center">
        <div className="relative -z-10 h-[300px] w-full overflow-hidden bg-[url('https://res.cloudinary.com/dyjirwjvp/image/upload/q_100/v1700916363/ourfleet/bannner/fleet-banner_eccy2x.webp')] bg-cover bg-[50%] bg-no-repeat blur-sm sm:h-[400px]"></div>
        <div className="container">
          <div className="-mt-[100px] block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:px-12 md:py-16">
            <div className="mb-12 grid gap-x-3  sm:grid-cols-3">
              <div className="mx-auto mb-12 text-center lg:mb-0">
                <svg
                  ...
                  strokeWidth="2"
                  stroke="currentColor"
                  className="dark:text-primary-400 mx-auto mb-6 h-12 w-12 text-white"
                >
                  <path
                ...
                <h6 className={`font-medium uppercase text-white`}>
                  Unites States
                </h6>
              </div>
              <div className="mx-auto mb-12 text-center lg:mb-0">
            ...
            <div className="mx-auto lg:px-36 md:px-14 px-0">
              <form>
                <div className="relative mb-6 flex flex-col">
                  <label className="mb-2 text-white" for="exampleInput90">
                    Topic *
                  </label>

                  <input
                    type="text"
                    className="bg-transparent border border-1 border-zinc-500 p-3 rounded text-white"
                    id="exampleInput90"
                    placeholder="Topic"
                  />
                </div>
                <div className="relative mb-6 flex xs:flex-row flex-col justify-between">
                  <div className="flex flex-col xs:w-[48%] xs:mb-0 mb-3">
                    ...
                    <input
                      type="text"
                      className="w-full bg-transparent border border-1 border-zinc-500 p-3 rounded text-white"
                      id="exampleInput90"
                ...
                <div className="relative mb-6 flex">
                  <div className="flex flex-col w-full">
                    <label className="mb-2 text-white w-full" for="exampleInput90">
                      Message
                    </label>

                   <textarea name="" id="" cols="30" rows="10" className="bg-transparent border border-1 border-zinc-500 p-3 rounded  text-white"></textarea>
                  </div>
                </div>
                <button
                  type="submit"
